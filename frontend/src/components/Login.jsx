            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label htmlFor="password" className="label label-required block text-sm font-medium text-slate-300">
                    Password
                  </label>
                  <button type="button" onClick={(e) => e.preventDefault()} className="text-sm text-amber-400 hover:text-amber-300 transition-colors">
                    Forgot password?
                  </button>
                </div>
                <div className="relative">
              ...
              <div className="text-center">
                <div className="inline-flex items-center gap-2 text-emerald-400">
                  ...
                  <span className="text-xs font-medium">Secure sign-in with 256-bit encryption</span>
                </div>
              </div>
            </form>
          </div>
